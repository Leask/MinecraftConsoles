...
- keep native desktop world-save restart covered by smoke
  (`ConsoleSaveFileOriginal` on the native desktop path now persists its
  in-memory save file table to a native save slot under
